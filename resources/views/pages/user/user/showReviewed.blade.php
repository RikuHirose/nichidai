    ...
    <div id="column_content">
      ...
      <div class="p-3">
        ...
        <ul class="nav nav-tabs">
          ...
          <li class="nav-item">
            <a href="{{ route('user.show.reviewed', $user->id) }}" class="nav-link active">レビューした授業</a>
          </li>
          <li class="nav-item">
            <a href="{{ route('user.show.history', $user->id) }}" class="nav-link">閲覧した授業</a>
          </li>
        </ul>
            ...
            <div class="col-xs-12">
              <div class="row">
                @isset($user_content['reviewed_lessons'])
                  ...
                  @foreach($user_content['reviewed_lessons'] as $model)
