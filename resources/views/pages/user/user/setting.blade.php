...
@section('content')
    ...
    <div class="p-auth-box">
        ...
        <div class="card auth-container">
            ...
            <div class="card-body">
                <div class="container">
                    <form action="{{ route('user.setting.post', $user->id) }}" method="post">
                         <!-- errors -->
                      @if ($errors->any())
                      ...
                      @endif
                        ...
                        <div class="form-group">
                            <input type="text" name="name" class="p-auth-box__field form-control"
                               placeholder="@lang('user.pages.auth.messages.name')" value="{{ $user->name }}">
                        </div>
                        <div class="form-group">
                            <input type="email" name="email" class="p-auth-box__field form-control"
                               placeholder="@lang('user.pages.auth.messages.email')" value="{{ $user->email }}">
                        </div>
