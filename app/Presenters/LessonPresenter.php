 ...
 * @property  int $evaluate_exam
 * @property  int $evaluate_report
 * @property  int $evaluate_mintest
 * @property  int $evaluate_apply
 * @property  int $evaluate_others
 * @property  int $evaluate_total
 * @property  string $url
 * @property  int $year
